...
import 'package:cinelens/presentation/watch/bloc/recommendation_movie_cubit.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class RecommendationMovies extends StatelessWidget {
  final String? movieID;
  const RecommendationMovies({super.key, this.movieID});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          RecommendationMovieCubit()..getRecommendationsMovie(movieID),
      child:
          BlocBuilder<RecommendationMovieCubit, BaseState<List<MovieEntity>>>(
