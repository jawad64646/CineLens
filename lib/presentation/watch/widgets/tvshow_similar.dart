...
import 'package:cinelens/presentation/watch/bloc/similar_tvshow.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class Similartvshow extends StatelessWidget {
  final String? showID;
  const Similartvshow({super.key, this.showID});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => SimilarTvshowCubit()..getTvshowSimilar(showID),
      child: BlocBuilder<SimilarTvshowCubit, BaseState<List<TvShowEntity>>>(
