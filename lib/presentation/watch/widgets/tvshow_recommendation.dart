...
import 'package:cinelens/presentation/watch/bloc/recommendation_tvshows.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class Recommendationtvshow extends StatelessWidget {
  final String? showID;
  const Recommendationtvshow({super.key, this.showID});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          RecommendationTvshowsCubit()..getTvshowRecommendation(showID),
      child:
          BlocBuilder<
            RecommendationTvshowsCubit,
            BaseState<List<TvShowEntity>>
          >(
